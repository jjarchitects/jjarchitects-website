...
//     <nav
//       ref={navRef}
//       className="bg-gray-200/40 backdrop-blur-lg fixed top-0 left-0 w-full z-50"
//     >
  ...
  return (
    ...
    >
      <div className="w-11/12 max-w-7xl mx-auto flex justify-between items-center relative">
        {/* Logo */}
        <Link href="/" ref={logoRef} className="relative z-50">
          <div className="relative w-12 h-12 flex items-center justify-center">
            <Image
              src="/assets/logo/logo.png"
              className="p-1 filter brightness-125"
              alt="Logo"
              fill
              priority
            />
